...
export default function Page() {
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center bg-palecream">
      <p className="font-mono text-2xl">Which one describes you?</p>
      <div className="flex w-3/5 items-center space-x-8 p-4">
        <div className="flex w-1/2 flex-col space-y-3 rounded-xl border border-gray-500 p-4">
